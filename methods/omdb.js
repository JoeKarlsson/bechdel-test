    ...
    omdbSimpleCast(splitTitle)
      .then(function (data) {
        return omdbFullCast(splitTitle)
          .then(function () {
            console.log('Finished retrieving all data from OMDB..');
...
function omdbSimpleCast(splitTitle) {
  return Q.promise(function (resolve, reject) {
    console.log('Started phase I - Retrieving Simple movie data from OMDB...');
...
function omdbFullCast(splitTitle) {
  return Q.promise(function (resolve, reject) {
    console.log('Started Phase II - Retreiving full character data from OMDB..');
...
function omdbDataParser(body) {
  ...
  for (var i = 0; i < rawMovieCharacters.length; i++) {
    //TODO Format char names - still has 'aroun some of the names'
