			...
			<div className="container">
				<header className="case-study-header">
					...
					<p className="case-study-subtitle">
						Analyzing gender representation in 2015 Oscar-nominated films through the Bechdel Test
					</p>
				</header>
				...
				<div className="case-study-content">
					...
					<div className="chart-section">
						...
						<p className="chart-description">
							Bechdel Test scores for 2015 Oscar-nominated films (1 = fails, 2 = partial pass, 3 = passes)
						</p>
					</div>
					...
					<div className="analysis-section">
						<p>
							...
							were able to test, only <span className="stat-highlight">38.46%</span> passed the Bechdel Test. This percentage
							is somewhat generous, as only <span className="stat-highlight">28.57%</span> of the Best Picture nominees
							passed the test. The category of Best Picture gives the best general
					...
					<div className="statistics">
						<p>
							<span className="stat-highlight">Key Findings:</span>
						</p>
						<p>• Only 38.46% of Oscar-nominated films passed the Bechdel Test</p>
						<p>• Only 28.57% of Best Picture nominees passed the test</p>
						<p>• All 8 Best Picture nominees featured male leads</p>
						<p>• 50% of films with Best Actress nominees passed vs. 20% with Best Actor nominees</p>
					</div>
					...
					<div className="analysis-section highlighted">
						<p>
					...
					<div className="challenges-section">
						<p>
							<strong>Methodological Notes:</strong> There were a few challenges that we faced in this Oscar film analysis
